...
export const translations = {
  fr: {
    ...
    legal_precedence_text:
      'Le présent service est édité en France et soumis à la législation française. La version française des mentions légales fait foi.',
    ...
    legal_section2_host_address_val:
      '440 N Barranca Ave #4133, Covina, CA 91723, États-Unis',
    legal_section2_host_site: "Site web de l'hébergeur",
    legal_section3_title: '3. Propriété intellectuelle',
    legal_section3_desc:
      "La marque Life-Track, les logos, la charte graphique, les algorithmes et l'ensemble des contenus textuels et visuels de l'application sont protégés au titre du droit d'auteur et de la propriété intellectuelle. Toute reproduction ou utilisation non autorisée est strictement interdite.",
    legal_section4_title: '4. Droit applicable et Litiges',
    legal_section4_desc:
      'Les présentes mentions légales sont régies par le droit français. Tout litige relatif à leur interprétation ou exécution sera soumis aux tribunaux français compétents.',

    // Politique de Confidentialité
    privacy_title: 'Politique de Confidentialité & RGPD',
    privacy_back: 'Retour',
    privacy_legal_precedence_badge: 'Information Juridique',
    privacy_legal_precedence_text:
      'La présente politique de protection des données est conforme au Règlement Général sur la Protection des Données (RGPD) et à la loi française "Informatique et Libertés". La version française fait foi.',
    privacy_sec1_title: '1. Responsable du Traitement',
    privacy_sec1_desc:
      'La protection de votre vie privée est une priorité absolue. Vos données personnelles sont traitées conformément au Règlement Général sur la Protection des Données (RGPD - Règlement UE 2016/679).',
    ...
    privacy_sec2_desc:
      'Nous appliquons le principe de minimisation des données (Art. 5 RGPD) : seules les données strictement nécessaires au fonctionnement de votre gestion budgétaire sont traitées.',
    privacy_sec2_item1_title: 'Identité & Connexion',
    privacy_sec2_item1_desc:
      'Adresse email et mot de passe sécurisé (haché par algorithme cryptographique). Vos identifiants ne sont jamais transmis à des tiers.',
    privacy_sec2_item2_title: 'Dépenses & Budgets',
    privacy_sec2_item2_desc:
      'Montants, catégories, dates et libellés saisis ou importés. Ces données sont stockées de façon isolée et sécurisée.',
    privacy_sec2_item3_title: 'Analyse IA (Gemini Flash)',
    privacy_sec2_item3_desc:
      "Les calculs d'optimisation budgétaire sont réalisés sur des flux strictement anonymisés (sans vos identifiants réels). L'IA ne conserve aucune trace d'apprentissage.",
    privacy_sec2_item4_title: 'Synchronisation Bancaire (Plaid)',
    privacy_sec2_item4_desc:
      'Vos accès bancaires ne transitent jamais par nos serveurs. Plaid opère en lecture seule sécurisée (normes bancaires européennes DSP2).',
    privacy_sec3_title: '3. Sécurité et Sous-traitants certifiés',
    privacy_sec3_desc:
      'Toutes les communications sont chiffrées de bout en bout (TLS/SSL, AES-256). Nous ne vendons et ne céderons JAMAIS vos données financières à des tiers à des fins publicitaires.',
    privacy_sec3_sub1_title: 'Vercel Inc.',
    privacy_sec3_sub1_desc:
      "Hébergement sécurisé de l'application et de l'infrastructure.",
    privacy_sec3_sub2_title: 'Stripe Inc.',
    privacy_sec3_sub2_desc:
      'Traitement certifié PCI-DSS des paiements et abonnements.',
    privacy_sec3_sub3_title: 'Plaid Inc.',
    privacy_sec3_sub3_desc:
      'Agrégation bancaire sécurisée et chiffrée de niveau bancaire.',
    privacy_sec4_title: "4. Conservation des Données et Droit à l'Oubli",
    privacy_sec4_desc:
      "Vos données sont conservées tant que votre compte utilisateur reste actif. Conformément au droit à l'effacement (Art. 17 RGPD), vous pouvez à tout instant supprimer définitivement l'intégralité de vos données directement depuis l'onglet « Paramètres » de l'application.",
    privacy_sec5_title: '5. Vos Droits et Réclamations (CNIL)',
    privacy_sec5_desc:
      "Conformément aux articles 15 à 22 du RGPD, vous disposez d'un droit d'accès, de rectification, de portabilité et de suppression de vos données personnelles.",
    privacy_sec5_exercise_label: 'Pour exercer vos droits',
    privacy_sec5_exercise_val:
      'Écrivez à leandro.dasilva@bbox.fr (réponse garantie sous 30 jours max).',
    privacy_sec5_cnil_info:
      "En cas de contestation non résolue, vous avez le droit d'introduire une réclamation auprès de la Commission Nationale de l'Informatique et des Libertés (CNIL - www.cnil.fr).",
    ...
    cookies_banner_desc:
      "Nous utilisons des cookies essentiels pour assurer la sécurité et le fonctionnement optimal de Life-Track. Avec votre accord, nous utilisons également des cookies de mesure d'audience anonymes pour améliorer nos services.",
    ...
    cookies_modal_subtitle:
      'Personnalisez vos choix de traceurs. Vos préférences sont conservées et modifiables à tout moment.',
    cookies_essential_title: 'Cookies essentiels & Sécurité',
    cookies_essential_badge: 'Toujours actif',
    cookies_essential_desc:
      'Indispensables pour la connexion sécurisée, la protection anti-CSRF et la mémorisation de votre langue et devise.',
    cookies_analytics_title: "Mesure d'audience & Performance",
    cookies_analytics_desc:
      "Statistiques anonymisées pour mesurer l'utilisation et optimiser la réactivité de Life-Track.",
    cookies_preferences_title: 'Personnalisation & Confort',
    cookies_preferences_desc:
      "Mémorisation des filtres et paramètres avancés d'affichage du tableau de bord.",
  ...
  en: {
    ...
    legal_precedence_text:
      'This service is operated from France and governed by French law. The French version of this legal notice prevails.',
    ...
    legal_section3_desc:
      'The Life-Track trademark, logo, design system, algorithms, and all textual and visual contents of the app are protected by copyright and intellectual property laws. Any unauthorized reproduction or use is strictly prohibited.',
    legal_section4_title: '4. Applicable Law & Jurisdiction',
    legal_section4_desc:
      'This legal notice is governed by French law. Any dispute relating to its interpretation or execution will be subject to the competent French courts.',
    ...
    privacy_legal_precedence_text:
      'This data protection policy complies with the General Data Protection Regulation (GDPR) and French Data Protection legislation. The French version prevails in case of dispute.',
    privacy_sec1_title: '1. Data Controller',
    privacy_sec1_desc:
      'Protecting your privacy is an absolute priority. Your personal data is processed in full compliance with the General Data Protection Regulation (GDPR - EU Regulation 2016/679).',
    ...
    privacy_sec2_desc:
      'We strictly apply the data minimization principle (Art. 5 GDPR): only data strictly necessary for your budget management is processed.',
    privacy_sec2_item1_title: 'Identity & Login',
    privacy_sec2_item1_desc:
      'Email address and securely hashed password. Your credentials are never shared with any third party.',
    privacy_sec2_item2_title: 'Expenses & Budgets',
    privacy_sec2_item2_desc:
      'Amounts, categories, dates, and labels entered or imported. This data is stored in isolated and secure environments.',
    privacy_sec2_item3_title: 'AI Analysis (Gemini Flash)',
    privacy_sec2_item3_desc:
      'Budget optimization calculations are performed on strictly anonymized payloads (no personal identities). The AI retains no user data for training.',
    privacy_sec2_item4_title: 'Bank Synchronization (Plaid)',
    privacy_sec2_item4_desc:
      'Your banking credentials never touch our servers. Plaid operates in secure, read-only mode compliant with PSD2 regulations.',
    privacy_sec3_title: '3. Security & Certified Sub-processors',
    privacy_sec3_desc:
      'All communications are end-to-end encrypted (TLS/SSL, AES-256). We do NOT and will NEVER sell or monetize your financial data.',
    privacy_sec3_sub1_title: 'Vercel Inc.',
    privacy_sec3_sub1_desc:
      'Secure hosting for application and infrastructure.',
    privacy_sec3_sub2_title: 'Stripe Inc.',
    privacy_sec3_sub2_desc:
      'PCI-DSS certified payment and subscription processing.',
    privacy_sec3_sub3_title: 'Plaid Inc.',
    ...
    privacy_sec4_desc:
      'Your data is retained as long as your account remains active. Under the right to erasure (Art. 17 GDPR), you can permanently delete all your data at any moment from your Settings.',
    privacy_sec5_title: '5. Your Rights & Regulatory Authorities (CNIL)',
    privacy_sec5_desc:
      'Under Articles 15 to 22 of the GDPR, you have the right to access, rectify, export, and delete your personal data.',
    privacy_sec5_exercise_label: 'To exercise your rights',
    privacy_sec5_exercise_val:
      'Email leandro.dasilva@bbox.fr (guaranteed response within 30 days).',
    privacy_sec5_cnil_info:
      'In case of unresolved dispute, you have the right to lodge a complaint with the French Data Protection Authority (CNIL - www.cnil.fr).',

    // Cookies & RGPD Consent Banner
    cookies_banner_badge: 'Privacy & Data Protection',
    cookies_banner_title: 'Cookie & Tracker Preferences',
    cookies_banner_desc:
      'We use essential cookies to ensure secure operations on Life-Track. With your consent, we also use anonymous analytics cookies to improve speed and user experience.',
    ...
    cookies_modal_subtitle:
      'Manage your tracker preferences. Your choices are saved and can be modified at any time.',
    cookies_essential_title: 'Essential & Security Cookies',
    cookies_essential_badge: 'Always active',
    cookies_essential_desc:
      'Required for secure login, anti-CSRF protection, and remembering your chosen language and currency.',
    cookies_analytics_title: 'Analytics & Performance',
    cookies_analytics_desc:
      'Anonymous metrics to measure feature usage and optimize Life-Track application performance.',
    cookies_preferences_title: 'User Experience & Preferences',
    cookies_preferences_desc:
      'Saves your advanced dashboard filters and display preferences for smooth navigation.',
  ...
  de: {
    ...
    legal_precedence_text:
      'Dieser Dienst wird in Frankreich betrieben und unterliegt französischem Recht. Die französische Version des Impressums ist maßgebend.',
    ...
    legal_section2_host_address_val:
      '440 N Barranca Ave #4133, Covina, CA 91723, Vereinigte Staaten',
    legal_section2_host_site: 'Webseite des Hosters',
    legal_section3_title: '3. Geistiges Eigentum',
    legal_section3_desc:
      'Die Marke Life-Track, Logos, Designelemente, Algorithmen und alle Inhalte sind urheberrechtlich geschützt. Jede unbefugte Nutzung oder Vervielfältigung ist strengstens untersagt.',
    legal_section4_title: '4. Anwendbares Recht & Gerichtsstand',
    legal_section4_desc:
      'Dieses Impressum unterliegt französischem Recht. Für alle Streitigkeiten sind ausschließlich die zuständigen französischen Gerichte zuständig.',
    ...
    privacy_legal_precedence_text:
      'Diese Datenschutzrichtlinie entspricht der Datenschutz-Grundverordnung (DSGVO). Bei Streitigkeiten gilt die französische Fassung.',
    privacy_sec1_title: '1. Verantwortliche Stelle',
    privacy_sec1_desc:
      'Der Schutz Ihrer Privatsphäre hat höchste Priorität. Ihre Daten werden gemäß der Datenschutz-Grundverordnung (DSGVO - EU 2016/679) verarbeitet.',
    ...
    privacy_sec2_desc:
      'Wir wenden das Prinzip der Datenminimierung an (Art. 5 DSGVO): Es werden nur Daten verarbeitet, die für die Budgetverwaltung zwingend erforderlich sind.',
    privacy_sec2_item1_title: 'Identität & Anmeldung',
    privacy_sec2_item1_desc:
      'E-Mail-Adresse und kryptografisch gehashtes Passwort. Ihre Zugangsdaten werden niemals an Dritte weitergegeben.',
    privacy_sec2_item2_title: 'Ausgaben & Budgets',
    privacy_sec2_item2_desc:
      'Eingegebene oder importierte Beträge, Kategorien und Daten. Speicherung in isolierten und geschützten Umgebungen.',
    privacy_sec2_item3_title: 'KI-Analyse (Gemini Flash)',
    privacy_sec2_item3_desc:
      'Budgetberechnungen erfolgen über vollständig anonymisierte Datenstrukturen. Die KI speichert keine Daten für Trainingszwecke.',
    privacy_sec2_item4_title: 'Bank-Synchronisation (Plaid)',
    privacy_sec2_item4_desc:
      'Ihre Bankzugangsdaten erreichen niemals unsere Server. Plaid arbeitet im schreibgeschützten Modus (PSD2-Standard).',
    privacy_sec3_title: '3. Sicherheit & Zertifizierte Auftragsverarbeiter',
    privacy_sec3_desc:
      'Alle Datenübertragungen sind durchgehend verschlüsselt (TLS/SSL, AES-256). Wir verkaufen NIEMALS Ihre Finanzdaten.',
    privacy_sec3_sub1_title: 'Vercel Inc.',
    privacy_sec3_sub1_desc: 'Sicheres Hosting für Anwendung und Infrastruktur.',
    privacy_sec3_sub2_title: 'Stripe Inc.',
    privacy_sec3_sub2_desc:
      'PCI-DSS-zertifizierte Abwicklung von Zahlungen und Abonnements.',
    privacy_sec3_sub3_title: 'Plaid Inc.',
    ...
    privacy_sec4_desc:
      'Ihre Daten bleiben gespeichert, solange Ihr Konto aktiv ist. Gemäß Art. 17 DSGVO können Sie jederzeit alle Ihre Daten unwiderruflich in den Kontoeinstellungen löschen.',
    privacy_sec5_title: '5. Ihre Rechte & Aufsichtsbehörden',
    privacy_sec5_desc:
      'Gemäß Art. 15 bis 22 DSGVO haben Sie das Recht auf Auskunft, Berichtigung, Datenübertragbarkeit und Löschung.',
    privacy_sec5_exercise_label: 'Zur Ausübung Ihrer Rechte',
    privacy_sec5_exercise_val:
      'E-Mail an leandro.dasilva@bbox.fr (Antwort binnen maximal 30 Tagen).',
    privacy_sec5_cnil_info:
      'Bei ungelösten Beschwerden können Sie sich an die zuständige Datenschutzbehörde wenden (CNIL - www.cnil.fr).',

    // Cookies & RGPD Consent Banner
    cookies_banner_badge: 'Schutz Ihrer Privatsphäre',
    cookies_banner_title: 'Cookie- & Tracker-Einstellungen',
    cookies_banner_desc:
      'Wir verwenden essenzielle Cookies für Sicherheit und Kernfunktionen von Life-Track. Mit Ihrer Zustimmung nutzen wir anonymisierte Analysen zur Leistungsverbesserung.',
    ...
    cookies_modal_subtitle:
      'Verwalten Sie Ihre Einstellungen. Ihre Auswahl wird gespeichert und kann jederzeit geändert werden.',
    cookies_essential_title: 'Essenzielle Cookies & Sicherheit',
    cookies_essential_badge: 'Immer aktiv',
    cookies_essential_desc:
      'Notwendig für sichere Anmeldung, CSRF-Schutz und Speicherung von Sprache und Währung.',
    cookies_analytics_title: 'Reichweitenmessung & Performance',
    cookies_analytics_desc:
      'Anonyme Nutzungsstatistiken zur Optimierung der Systemgeschwindigkeit und Benutzerführung.',
    cookies_preferences_title: 'Personalisierung & Komfort',
    cookies_preferences_desc:
      'Speichert erweiterte Dashboard-Filter und Darstellungsoptionen.',
  ...
  es: {
    ...
    legal_precedence_text:
      'Este servicio está editado en Francia y sujeto a la legislación francesa. La versión en francés del aviso legal es la que prevalece.',
    ...
    legal_section3_desc:
      'La marca Life-Track, los logotipos, el diseño gráfico, los algoritmos y todo el contenido de la aplicación están protegidos por derechos de autor y propiedad intelectual. Queda prohibida cualquier reproducción no autorizada.',
    legal_section4_title: '4. Ley aplicable y Jurisdicción',
    legal_section4_desc:
      'El presente aviso legal se rige por la legislación francesa. Cualquier litigio se someterá a los tribunales franceses competentes.',
    ...
    privacy_legal_precedence_text:
      'Esta política de protección de datos cumple con el Reglamento General de Protección de Datos (RGPD). En caso de litigio, prevalece la versión francesa.',
    privacy_sec1_title: '1. Responsable del Tratamiento',
    privacy_sec1_desc:
      'La protección de su privacidad es una prioridad absoluta. Sus datos personales se procesan de conformidad con el RGPD (Reglamento UE 2016/679).',
    privacy_sec1_resp_label: 'Responsable',
    privacy_sec1_resp_val: 'DA SILVA COSTA Léandro José EI',
    privacy_sec1_contact_label: 'Contacto de Privacidad',
    privacy_sec2_title: '2. Datos Recopilados y Anonimización',
    privacy_sec2_desc:
      'Aplicamos el principio de minimización de datos (Art. 5 RGPD): solo se procesan los datos estrictamente necesarios para su gestión presupuestaria.',
    privacy_sec2_item1_title: 'Identidad y Acceso',
    privacy_sec2_item1_desc:
      'Correo electrónico y contraseña con cifrado seguro. Sus credenciales nunca se comparten con terceros.',
    privacy_sec2_item2_title: 'Gastos y Presupuestos',
    privacy_sec2_item2_desc:
      'Importes, categorías, fechas y conceptos. Estos datos se almacenan en entornos aislados y seguros.',
    privacy_sec2_item3_title: 'Análisis de IA (Gemini Flash)',
    privacy_sec2_item3_desc:
      'Los cálculos de optimización se realizan sobre datos estrictamente anonimizados (sin identidades). La IA no almacena datos de entrenamiento.',
    privacy_sec2_item4_title: 'Sincronización Bancaria (Plaid)',
    privacy_sec2_item4_desc:
      'Sus credenciales bancarias nunca tocan nuestros servidores. Plaid opera en modo solo lectura seguro (normativa europea PSD2).',
    privacy_sec3_title: '3. Seguridad y Proveedores Certificados',
    privacy_sec3_desc:
      'Todas las comunicaciones están cifradas de extremo a extremo (TLS/SSL, AES-256). NUNCA venderemos sus datos financieros a terceros.',
    privacy_sec3_sub1_title: 'Vercel Inc.',
    privacy_sec3_sub1_desc:
      'Alojamiento seguro para la aplicación e infraestructura.',
    privacy_sec3_sub2_title: 'Stripe Inc.',
    privacy_sec3_sub2_desc:
      'Procesamiento de pagos y suscripciones certificado PCI-DSS.',
    privacy_sec3_sub3_title: 'Plaid Inc.',
    privacy_sec3_sub3_desc:
      'Agregación bancaria cifrada con estándares bancarios.',
    privacy_sec4_title: '4. Conservación de Datos y Derecho al Olvido',
    privacy_sec4_desc:
      'Sus datos se conservan mientras su cuenta permanezca activa. Conforme al derecho de supresión (Art. 17 RGPD), puede eliminar definitivamente todos sus datos desde Ajustes.',
    privacy_sec5_title: '5. Sus Derechos y Autoridades (CNIL)',
    privacy_sec5_desc:
      'En virtud de los artículos 15 a 22 del RGPD, tiene derecho a acceder, rectificar, portar y eliminar sus datos personales.',
    privacy_sec5_exercise_label: 'Para ejercer sus derechos',
    privacy_sec5_exercise_val:
      'Escriba a leandro.dasilva@bbox.fr (respuesta garantizada en menos de 30 días).',
    privacy_sec5_cnil_info:
      'En caso de litigio no resuelto, tiene derecho a presentar una reclamación ante la autoridad de protección de datos competente (CNIL - www.cnil.fr).',

    // Cookies & RGPD Consent Banner
    cookies_banner_badge: 'Privacidad y Protección de Datos',
    cookies_banner_title: 'Gestión de cookies y rastreadores',
    cookies_banner_desc:
      'Utilizamos cookies esenciales para la seguridad y el correcto funcionamiento de Life-Track. Con su consentimiento, también usamos analítica anónima para mejorar el servicio.',
    ...
    cookies_modal_subtitle:
      'Gestione sus preferencias. Sus opciones se guardan y pueden modificarse en cualquier momento.',
    cookies_essential_title: 'Cookies esenciales y de seguridad',
    cookies_essential_badge: 'Siempre activo',
    cookies_essential_desc:
      'Imprescindibles para inicio de sesión seguro, protección anti-CSRF e idioma/moneda.',
    cookies_analytics_title: 'Medición de audiencia y rendimiento',
    cookies_analytics_desc:
      'Estadísticas anónimas para optimizar la velocidad y usabilidad de la plataforma.',
    cookies_preferences_title: 'Personalización de la experiencia',
    cookies_preferences_desc:
      'Memorizan filtros avanzados y configuración de visualización del panel.',
  ...
  pt: {
    ...
    legal_precedence_text:
      'Este serviço é editado em França e está sujeito à legislação francesa. A versão em língua francesa do aviso legal prevalece.',
    ...
    legal_section3_desc:
      'A marca Life-Track, os logótipos, a identidade visual, os algoritmos e todos os conteúdos estão protegidos por direitos de autor e propriedade intelectual. Qualquer reprodução não autorizada é estritamente proibida.',
    legal_section4_title: '4. Legislação Aplicável e Jurisdição',
    legal_section4_desc:
      'O presente aviso legal é regido pela legislação francesa. Qualquer litígio será submetido aos tribunais franceses competentes.',
    ...
    privacy_legal_precedence_text:
      'Esta política de proteção de dados está em conformidade com o Regulamento Geral sobre a Proteção de Dados (RGPD). Em caso de litígio, prevalece a versão em francês.',
    privacy_sec1_title: '1. Responsável pelo Tratamento',
    privacy_sec1_desc:
      'A proteção da sua privacidade é uma prioridade absoluta. Os seus dados pessoais são tratados em conformidade com o RGPD (Regulamento UE 2016/679).',
    ...
    privacy_sec2_desc:
      'Aplicamos o princípio da minimização de dados (Art. 5 RGPD): apenas os dados estritamente necessários para a gestão orçamental são tratados.',
    privacy_sec2_item1_title: 'Identidade e Acesso',
    privacy_sec2_item1_desc:
      'Endereço de email e palavra-passe com hash criptográfico. As suas credenciais nunca são partilhadas com terceiros.',
    privacy_sec2_item2_title: 'Despesas e Orçamentos',
    privacy_sec2_item2_desc:
      'Montantes, categorias, datas e descrições. Estes dados são armazenados em ambientes isolados e seguros.',
    privacy_sec2_item3_title: 'Análise de IA (Gemini Flash)',
    privacy_sec2_item3_desc:
      'Os cálculos de otimização são realizados em dados estritamente anonimizados (sem identidades). A IA não armazena dados para treino.',
    privacy_sec2_item4_title: 'Sincronização Bancária (Plaid)',
    privacy_sec2_item4_desc:
      'As suas credenciais bancárias nunca passam pelos nossos servidores. O Plaid opera em modo de leitura seguro (norma europeia DSP2).',
    privacy_sec3_title: '3. Segurança e Subcontratantes Certificados',
    privacy_sec3_desc:
      'Todas as comunicações são encriptadas de ponta a ponta (TLS/SSL, AES-256). NUNCA venderemos os seus dados financeiros a terceiros.',
    privacy_sec3_sub1_title: 'Vercel Inc.',
    privacy_sec3_sub1_desc:
      'Alojamento seguro para a aplicação e infraestrutura.',
    privacy_sec3_sub2_title: 'Stripe Inc.',
    privacy_sec3_sub2_desc:
      'Processamento de pagamentos e subscrições certificado PCI-DSS.',
    privacy_sec3_sub3_title: 'Plaid Inc.',
    ...
    privacy_sec4_desc:
      'Os seus dados são mantidos enquanto a sua conta permanecer ativa. Sob o direito ao apagamento (Art. 17 RGPD), pode eliminar definitivamente todos os seus dados nas Definições.',
    privacy_sec5_title: '5. Os Seus Direitos e Contacto (CNIL)',
    privacy_sec5_desc:
      'Nos termos dos artigos 15 a 22 do RGPD, tem o direito de aceder, retificar, transferir e eliminar os seus dados pessoais.',
    privacy_sec5_exercise_label: 'Para exercer os seus direitos',
    privacy_sec5_exercise_val:
      'Envie um email para leandro.dasilva@bbox.fr (resposta garantida em até 30 dias).',
    privacy_sec5_cnil_info:
      'Em caso de litígio não resolvido, tem o direito de apresentar uma reclamação junto da autoridade de proteção de dados competente (CNIL - www.cnil.fr).',

    // Cookies & RGPD Consent Banner
    cookies_banner_badge: 'Privacidade e Proteção de Dados',
    cookies_banner_title: 'Gestão de cookies e rastreadores',
    cookies_banner_desc:
      'Utilizamos cookies essenciais para garantir a segurança e o funcionamento de Life-Track. Com o seu consentimento, usamos análises anónimas para melhorar o serviço.',
    cookies_accept_all: 'Aceitar tudo',
    cookies_reject_all: 'Rejeitar não essenciais',
    cookies_customize: 'Personalizar',
    cookies_modal_title: 'Preferências de cookies',
    cookies_modal_subtitle:
      'Faça a gestão dos rastreadores. As suas opções são guardadas e podem ser alteradas a qualquer momento.',
    cookies_essential_title: 'Cookies essenciais e de segurança',
    cookies_essential_badge: 'Sempre ativo',
    cookies_essential_desc:
      'Indispensáveis para sessão segura, proteção anti-CSRF e retenção de idioma/moeda.',
    cookies_analytics_title: 'Medição de audiência e desempenho',
    cookies_analytics_desc:
      'Estatísticas anónimas para otimizar o desempenho e ergonomia da aplicação.',
    cookies_preferences_title: 'Personalização da experiência',
    cookies_preferences_desc:
      'Memoriza filtros avançados e opções de visualização do painel.',
